// -----------------------------------------------------------------------------
// VENDORED — do not replace with a UPM git reference. See VENDORED.md in the
// parent folder for the rationale and for the list of local modifications.
//
//   Upstream : Unity-Technologies/multiplayer-community-contributions
//   Path     : Transports/com.community.netcode.transport.steamnetworkingsockets
//   Commit   : d862504b148f6c3a31763797900eb5a54d4625a5 (2023-05-19)
//   License  : MIT, Copyright (c) 2021 Unity Technologies (see LICENSE.md)
//
// Vendored 2026-08-08 for the Netcode for Entities -> NGO + Steam migration.
// Unity disclaims support for this repository's contents, and the package
// metadata is unreliable (package.json says 1.0.1, CHANGELOG says 2.0.1), so it
// lives here where it can be patched without a fork-and-PR cycle.
// -----------------------------------------------------------------------------
