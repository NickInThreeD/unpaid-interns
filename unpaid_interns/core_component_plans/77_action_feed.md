...
- **Quota met**, and **the round is ending** — the departure warning ([`31_entry_point_extraction_zone.md`](31_entry_point_extraction_zone.md) requires it to be loud and immediate; the feed is one of the channels).
